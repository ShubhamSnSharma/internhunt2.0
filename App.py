    ...
    st.markdown(f"""
        <div style="text-align: center; margin-bottom: 3rem; padding: 2rem 0;">
            <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem;">
                ...
                <div>
                    <h1 style="margin: 0; background: {StyleManager.COLORS['primary_gradient']}; 
            ...
            <h2 style="color: inherit; margin: 0 0 1rem 0; font-weight: 600; opacity: 0.8;">
                AI-Powered Resume Analyzer
            </h2>
            <p style="color: inherit; max-width: 600px; margin: 0 auto; opacity: 0.7; line-height: 1.7;">
                Transform your career journey with intelligent resume analysis, personalized job recommendations, 
                and skill insights powered by advanced AI.
            </p>
        </div>
        ...
        <div class="feature-container">
            <div class="feature-card">
                ...
                <div class="feature-sub">AI-powered skill extraction</div>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🎯</div>
                <div class="feature-title">Job Matching</div>
                <div class="feature-sub">Personalized recommendations</div>
            </div>
            <div class="feature-card">
                <div class="feature-icon">💬</div>
                <div class="feature-title">AI Assistant</div>
                <div class="feature-sub">Interactive career guidance</div>
            </div>
        </div>
    """, unsafe_allow_html=True)
...
def main():
    ...
    if st.session_state.page == "landing":
        ...
        if choice == 'User':
            ...
            st.markdown("""
                <div style="
                    background-color: #0b1221; padding: 30px; border-radius: 12px; border: 1.5px solid #475569; 
                    margin-bottom: 25px; max-width: 700px; margin-left: auto; margin-right: auto; 
                    box-shadow: 0 4px 15px rgba(0, 0, 0, 0.3);
                ">
                    <div style="
                        font-size: 24px; font-weight: 700; color: #ffffff; padding-bottom: 12px; 
                        border-bottom: 2px solid #374151; margin-bottom: 20px;
                    ">
                        📄 Upload Your Resume
                    </div>
            ...
            if resume_data:
                ...
                with col1:
                    location_input = st.text_input("Location", placeholder="Enter your Preferred Location (Leave blank for remote jobs)", key="search_location")
                with col2:
                ...
                if st.session_state.get('render_chat_at_bottom'):
                    ...
                    if user_text is None:
                        with st.form("chat_form", clear_on_submit=True):
                            ...
                            with c_in1:
                                user_text_value = st.text_input("Chat Input", placeholder="Ask me anything about your resume, career, or job search...", key="chat_text_input")
                            with c_in2:
